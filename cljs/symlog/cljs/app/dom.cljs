...
(def elements {
          ...
          :narratorSkipButton           (goog.dom.getElement "narratorSkipButton")
          :narratorSkipTouchArea        (goog.dom.getElement "narratorSkipTouchArea")
          ...
          :narratorScenes               (goog.dom.getElementsByClass "nscene")         
